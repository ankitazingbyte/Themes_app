class MainThemesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @main_theme.save
        format.html { redirect_to @main_theme, notice: 'Main theme was successfully created.' }
  ...
  def update
    respond_to do |format|
      if @main_theme.update(main_theme_params)
        format.html { redirect_to @main_theme, notice: 'Main theme was successfully updated.' }
